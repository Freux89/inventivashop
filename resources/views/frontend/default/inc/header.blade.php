<header class="gheader position-relative z-2 header-sticky">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xxl-4 col-xl-3">
                    <div class="topbar-nav d-none d-xl-block">
                        <ul class="nav">
                            <li class="nav-item">
    ...
    <div class="container">
        <div class="gshop-navbar bg-white rounded position-relative py-6">
            <div class="row align-items-center">
                ...
                <div class="col-xxl-5 col-xl-5 col-md-5 col-5">
            ...
            <div class="row">
            <nav class="gshop-navmenu d-none d-xl-block p-0 my-3">
