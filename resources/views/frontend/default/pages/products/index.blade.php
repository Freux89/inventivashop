                        ...
                        <div class="listing-top d-flex align-items-center justify-content-between flex-wrap gap-3 bg-white rounded-2 px-4 py-4 mb-5">
                            ...
                            <div class="listing-top-right text-end d-inline-flex align-items-center gap-3 flex-wrap">
                                <div class="number-count-filter d-flex align-items-center gap-3">
                                    ...
                                    <input type="number" @isset($per_page) value="{{ $per_page }}" @else value="9" @endisset name="per_page" class="product-listing-pagination">
                                </div>
                                <div class="select-filter d-inline-flex align-items-center gap-3">
                                    ...
                                    <select name="sort_by" class="sort_by form-select fs-xxs fw-medium theme-select select-sm">
                                        <option value="new" @isset($sort_by) @if ($sort_by=='new' ) selected @endif @endisset>
                                            {{ localize('Newest First') }}
                                        </option>
                                        <option value="best_selling" @isset($sort_by) @if ($sort_by=='best_selling' ) selected @endif @endisset>
                                            {{ localize('Best Selling') }}
                                        </option>
                                    </select>
                                </div>
                                <a href="{{ route('products.index') }}?view=grid" class="grid-btn {{ request()->view != 'list' ? 'active' : '' }} d-none d-xl-flex">
