    ...
    <div class="row">
        <div class="col-12 col-lg-8 pe-lg-6">
            ...
            <form action="" class="add-to-cart-form" id="addToCartForm">
                ...
                <input type="hidden" name="product_variation_id" @if (!$isVariantProduct && empty($product_variationIds)) value="{{ $product->variations[0]->id }}" @else value="{{ implode(',', $product_variationIds) }}" @endif >
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap mt-5">
                    <div class="product-qty qty-increase-decrease d-flex flex-column">
