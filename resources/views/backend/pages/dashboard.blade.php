...
<section class="tt-section pt-4">
    <div class="container">
                ...
                <div class="card tt-page-header">
                    <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                        ...
                        <div class="tt-action">
                            ...
                            @can('manage_orders')
                            <a href="{{ route('admin.orders.index') }}" class="btn btn-secondary"><i data-feather="shopping-cart" class="me-2"></i>{{ localize('Manage Sales') }}</a>
                            @endcan

                            @can('add_products')
                            <a href="{{ route('admin.products.create') }}" class="btn btn-primary ms-2"><i data-feather="plus" class="me-2"></i>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="dropdown tt-tb-dropdown fs-sm">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                            <a class="dropdown-item" href="{{ route('admin.dashboard') }}">{{ localize('Last 7 days') }}</a>
                                            <a class="dropdown-item" href="{{ route('admin.dashboard') }}?&timeline=30">{{ localize('Last 30 days') }}</a>
                                            <a class="dropdown-item" href="{{ route('admin.dashboard') }}?&timeline=90">{{ localize('Last 3 months') }}</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tt-top-selling mt-3 h-25rem" data-simplebar>
                            <ul class="tt-top-selling-list list-unstyled mb-0 px-3">
                                ...
                                <li class="py-3 d-flex align-items-center justify-content-between">
                                    ...
                                    <span class="fw-bold heading-font text-end  cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ localize('Total Sales') }}">({{ $product->total_sale_count }})</span>
                                </li>
                                @endforeach
                            </ul>
                        </div>
        ...
        <div class="row g-3 mb-3">
            ...
            <a href="{{ route('admin.orders.index') }}?delivery_status={{ orderPendingStatus() }}" class="col-lg-3 col-sm-6">
                <div class="card h-100 flex-column">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-lg">
            ...
            <a href="{{ route('admin.orders.index') }}?delivery_status={{ orderProcessingStatus() }}" class="col-lg-3 col-sm-6">
                <div class="card h-100 flex-column">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-lg">
            ...
            <a href="{{ route('admin.orders.index') }}?delivery_status={{ orderDeliveredStatus() }}" class="col-lg-3 col-sm-6">
                <div class="card h-100 flex-column">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-lg">
                    ...
                    <table class="table tt-footable border-top align-middle" data-use-parent-width="true">
                        <thead>
                            <tr>
                                ...
                                <th data-breakpoints="xs">{{ localize('Stato ordine') }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <!-- <td>
                                    <span class="badge rounded-pill text-capitalize {{ $order->shipping_delivery_type == getScheduledDeliveryType() ? 'bg-soft-warning' : 'bg-secondary' }}">
                                        {{ Str::title(Str::replace('_', ' ', $order->shipping_delivery_type)) }}
                                    </span>
                                </td> -->

                                <td class="text-end">
                                    <a href="{{ route('admin.orders.show', $order->id) }}" class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip" data-bs-placement="top" title="View Details">
        ...
        <div class="row g-3 mb-3">
            @can('manage_orders')
            <a href="{{ route('admin.orders.index') }}?delivery_status={{ orderPickedUpStatus() }}" class="col-lg-3 col-sm-6">
                <div class="card h-100 flex-column">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-lg">
            ...
            <a href="{{ route('admin.orders.index') }}?order_state_id={{ implode(',', orderCancelledStatus()) }}" class="col-lg-3 col-sm-6">
                <div class="card h-100 flex-column">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-lg">
            ...
            <a href="{{ route('admin.orders.index') }}?delivery_status={{ orderOutForDeliveryStatus() }}" class="col-lg-3 col-sm-6">
                <div class="card h-100 flex-column">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-lg">
            ...
            <a href="{{ route('admin.orders.index') }}?payment_status={{ paidPaymentStatus() }}" class="col-lg-3 col-sm-6">
                <div class="card h-100 flex-column">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-lg">
            ...
            <a href="{{ route('admin.orders.index') }}?payment_status={{ unpaidPaymentStatus() }}" class="col-lg-3 col-sm-6">
                <div class="card h-100 flex-column">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-lg">
