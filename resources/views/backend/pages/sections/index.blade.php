...
@section('title')
{{ localize('Sezioni') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
    ...
    <div class="container">
                ...
                <div class="card tt-page-header">
                    <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                        <div class="tt-page-title">
                            <h2 class="h5 mb-lg-0">{{ localize('Sezioni') }}</h2>
                        </div>
                        <div class="tt-action">

                            <a href="{{ route('admin.sections.create') }}" class="btn btn-primary"><i data-feather="plus"></i> {{ localize('Aggiungi sezione') }}</a>
        ...
        <div class="row mb-4 g-4">
            ...
            <div class="col-xl-12 order-2 order-md-2 order-lg-2 order-xl-1">
                        ...
                        <div class="card mb-4" id="section-1">
                                ...
                                <tbody>
                                    ...
                                    <tr data-id="{{ $section->id }}">
                                        ...
                                        <td class="text-start">
                                            ...
                                            <a href="{{ route('admin.sections.edit', ['id' => $section->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}" class="d-inline-block">
                                        ...
                                        <td> {{ localize($section->type) }}</td>

                                        <td>
                                            <div class="form-check form-switch">
                                                <input type="checkbox" class="form-check-input" onchange="updateStatus(this)" @if ($section->is_active) checked @endif
                                                value="{{ $section->id }}">
                                            </div>
                                        </td>
                                        <td class="text-end">
                            ...
                            <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                                <span>{{ localize('Showing') }}
                                    {{ $sections->firstItem() }}-{{ $sections->lastItem() }} {{ localize('of') }}
                                    {{ $sections->total() }} {{ localize('results') }}</span>
                                <nav>
                ...
                @can('add_sections')
                <form action="{{ route('admin.sections.store') }}" class="pb-650" method="POST">
...
<script>
    ...
    function updateStatus(el) {
        ...
        $.post('{{ route("admin.sections.updateStatus") }}', {
                _token: '{{ csrf_token() }}',
                id: el.value,
                is_active: is_active
            },
