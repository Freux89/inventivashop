            ...
            <div class="col-12">
                <div class="card tt-page-header">
                    <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                        ...
                        <div class="tt-action">
                            @can('add_coupons')
                            <a href="{{ route('admin.coupons.create') }}" class="btn btn-primary"><i data-feather="plus"></i> {{ localize('Add Coupon') }}</a>
                            @endcan
                        </div>
                    </div>
                </div>
                                ...
                                <td>
                                    ...
                                    @if(!empty($coupon->banner))
                                        <div class="avatar avatar-sm">
                                            ...
                                            <img class="rounded-circle" src="{{ uploadedAsset($coupon->banner) }}" alt="{{ $coupon->code }}" />
                                ...
                                <td class="text-end">
                                    <div class="dropdown tt-tb-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                            ...
                                            @can('edit_coupons')
                                            <a class="dropdown-item" href="{{ route('admin.coupons.edit', ['id' => $coupon->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}&localize">
                                                <i data-feather="edit-3" class="me-2"></i>{{ localize('Edit') }}
                                            </a>
                                            @endcan

                                            @can('delete_coupons')
                                            <a href="#" class="dropdown-item confirm-delete" data-href="{{ route('admin.coupons.delete', $coupon->id) }}" title="{{ localize('Delete') }}">
