                    ...
                    <form class="app-search" action="{{ Request::fullUrl() }}" method="GET">
                        <div class="card-header border-bottom-0">
                            <div class="row justify-content-between g-3">
                                ...
                                <div class="col-auto">
                                    <div class="input-group">
                                        <select class="form-select select2" name="is_banned" data-minimum-results-for-search="Infinity">
                                            <option value="">{{ localize('Select status') }}</option>

                                            <option value="0" @isset($is_banned) @if ($is_banned==0) selected @endif @endisset>
                                                {{ localize('Active') }}
                                            </option>

                                            <option value="1" @isset($is_banned) @if ($is_banned==1) selected @endif @endisset>
                                                {{ localize('Banned') }}
                                            </option>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="form-check form-switch d-flex justify-content-end">
                                        <input type="checkbox" onchange="updateBanStatus(this)" class="form-check-input" @if ($customer->is_banned) checked @endif
                                        value="{{ $customer->id }}">
                                    </div>
                                    @endcan
                                </td>
                                ...
                                <div class="dropdown tt-tb-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                ...
                                                <a class="dropdown-item" href="{{ route('admin.customers.edit', $customer->id) }}">
                                                    <i data-feather="edit" class="align-middle me-2"></i>
                                                    {{ localize('Edit') }}
                                                </a>
                                                @endcan

                                                @can('delete_customers')
                                                <a href="#" class="dropdown-item confirm-delete" data-href="{{ route('admin.customers.delete', $customer->id) }}" title="{{ localize('Delete') }}">
