                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 d-flex align-items-center">
                                <input type="checkbox" name="sub_title_style[is_bold]" class="me-2" {{ isset($slider->sub_title_style->is_bold) && $slider->sub_title_style->is_bold ? 'checked' : '' }}>
                        ...
                        <div class="row mt-2">
                            <div class="col-6">
                                <select name="sub_title_style[tag]" class="form-control">
                                    <option value="h1" {{ isset($slider->sub_title_style->tag) && $slider->sub_title_style->tag === 'h1' ? 'selected' : '' }}>h1</option>
                                    <option value="h2" {{ isset($slider->sub_title_style->tag) && $slider->sub_title_style->tag === 'h2' ? 'selected' : '' }}>h2</option>
                                    <option value="h3" {{ isset($slider->sub_title_style->tag) && $slider->sub_title_style->tag === 'h3' ? 'selected' : '' }}>h3</option>
                                    <option value="h4" {{ isset($slider->sub_title_style->tag) && $slider->sub_title_style->tag === 'h4' ? 'selected' : '' }}>h4</option>
                                    <option value="h5" {{ isset($slider->sub_title_style->tag) && $slider->sub_title_style->tag === 'h5' ? 'selected' : '' }}>h5</option>
                                    <option value="h6" {{ isset($slider->sub_title_style->tag) && $slider->sub_title_style->tag === 'h6' ? 'selected' : '' }}>h6</option>
                                    <option value="p" {{ isset($slider->sub_title_style->tag) && $slider->sub_title_style->tag === 'p' ? 'selected' : '' }}>p</option>
                                    <option value="div" {{ isset($slider->sub_title_style->tag) && $slider->sub_title_style->tag === 'div' ? 'selected' : '' }}>div</option>
                                    <option value="span" {{ isset($slider->sub_title_style->tag) && $slider->sub_title_style->tag === 'span' ? 'selected' : '' }}>span</option>
                                </select>
                            </div>
                            <div class="col-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 d-flex align-items-center">
                                <input type="checkbox" name="title_style[is_bold]" class="me-2" {{ isset($slider->title_style->is_bold) && $slider->title_style->is_bold ? 'checked' : '' }}>
                                <label class="form-check-label">{{ localize('Grassetto') }}</label>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-6">
                                <select name="title_style[tag]" class="form-control">
                                    <option value="h1" {{ isset($slider->title_style->tag) && $slider->title_style->tag === 'h1' ? 'selected' : '' }}>h1</option>
                                    <option value="h2" {{ isset($slider->title_style->tag) && $slider->title_style->tag === 'h2' ? 'selected' : '' }}>h2</option>
                                    <option value="h3" {{ isset($slider->title_style->tag) && $slider->title_style->tag === 'h3' ? 'selected' : '' }}>h3</option>
                                    <option value="h4" {{ isset($slider->title_style->tag) && $slider->title_style->tag === 'h4' ? 'selected' : '' }}>h4</option>
                                    <option value="h5" {{ isset($slider->title_style->tag) && $slider->title_style->tag === 'h5' ? 'selected' : '' }}>h5</option>
                                    <option value="h6" {{ isset($slider->title_style->tag) && $slider->title_style->tag === 'h6' ? 'selected' : '' }}>h6</option>
                                    <option value="p" {{ isset($slider->title_style->tag) && $slider->title_style->tag === 'p' ? 'selected' : '' }}>p</option>
                                    <option value="div" {{ isset($slider->title_style->tag) && $slider->title_style->tag === 'div' ? 'selected' : '' }}>div</option>
                                    <option value="span" {{ isset($slider->title_style->tag) && $slider->title_style->tag === 'span' ? 'selected' : '' }}>span</option>
                                </select>
                            </div>
                            <div class="col-6">
