  ...
  (n.caretArrows[0].up || n.caretArrows[0].down) &&
        ...
        $(this).on(n.menuBehaviour, function () {
          ...
          if (window.innerWidth >= 768) {
            ...
            if (t[s] != o[e] || $(l[e]).hasClass("active")) {
              $(l[e]).css("opacity", "0");
              $(l[e]).slideUp(300, function () {
                // Chiusura con animazione di scorrimento
              ...
              l.not($(l[e]))
                ...
                .slideUp(300, function () {
                  // Imposta l'opacità a 0 quando l'animazione è terminata
            ...
            if (t[s] != o[e] || $(l[e]).hasClass("active")) {
              ...
              $(".main-links").addClass("active"); // Mostra .main-links quando il dropdown è chiuso
              $(this).find("span").removeClass(h).addClass(d);
            } else {
              l.removeClass("active");
              $(l[e]).addClass("active");
              $(".main-links").removeClass("active")// Nascondi .main-links quando il dropdown è attivo
              $(this).find("span").removeClass(d).addClass(h);
            }
          }
    ...
    $(document).ready(function () {
      $(".back-link").on("click", function (e) {
        ...
        $(".menu-item-wrapper").removeClass("active").hide(); 
    
        // Mostra nuovamente il menu principale
        $(".main-links").addClass("active").show();
    
        // Rimuovi le classi highlight e caret dalle voci di menu
        $(".main-links ul li span").removeClass("highlight");
        $(".main-links ul li span .caret").removeClass("up").addClass("down");
        $(".menu-overlay").fadeIn();
      });
    });
};
...
$(document).ready(function () {
  ...
  function updateOverlay() {
    if (window.innerWidth < 768) { // Modalità Mobile
        if ($(".main-links.active").length > 0 || $(".menu-item-wrapper.active").length > 0) {
            $(".menu-overlay").fadeIn(); // Mostra l'overlay
        } else {
            $(".menu-overlay").fadeOut(); // Nascondi l'overlay
        }
    } else { // Modalità Desktop
...
document.querySelectorAll(".menu-item-wrapper, .main-links").forEach(function (item) {
  ...
  $(".close-menu").on("click", function (e) {
    ...
    $(".menu-item-wrapper").removeClass("active"); // Rimuovi la classe active da tutti i submenù
     // Chiudi il menu dropdown con animazione
